    ...
    <nav style={{
      ...
      <div style={{
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <Image src="/logo.jpg" alt="Web3 Jobs HQ" width={38} height={38}
        ...
        <div style={{ display: "flex", gap: 28, alignItems: "center" }} className="hidden-mobile">
          {links.map(l => (
            <Link key={l.label} href={l.href} style={{
              fontSize: 13, color: "var(--w70)", textDecoration: "none", letterSpacing: "0.01em",
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }} className="hidden-mobile">
          ...
          <Link href="/hire" style={{
            ...
            color: "#3D2200", padding: "7px 20px", borderRadius: 7,
      ...
      {/* Mobile drawer */}
      {open && (
        <div style={{ background: "var(--blue)", borderTop: "0.5px solid var(--bd)", padding: "16px 24px 24px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 0, marginBottom: 20 }}>
            {links.map(l => (
              <Link key={l.label} href={l.href} onClick={() => setOpen(false)} style={{
                fontSize: 15, color: "var(--w70)", textDecoration: "none",
                padding: "12px 0", borderBottom: "0.5px solid var(--bd)",
              }}>{l.label}</Link>
            ))}
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <Link href="/hire" onClick={() => setOpen(false)} style={{
              fontSize: 14, fontWeight: 700, fontFamily: "var(--font-syne)",
              color: "#3D2200", padding: "12px", borderRadius: 8,
